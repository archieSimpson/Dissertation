...
class MetricsRecorder:
    ...
    def record(self, step: int, flock: list[SheepAgent], scenario: str, food: FoodLandscape) -> None:
        ...
        mean_pressure = food.mean_pressure()
        degraded_area_pct = food.degraded_area_percentage()
        mean_ndvi = 100.0 * float(np.mean(food.ndvi))
        ...
        self.group_rows.append(
            {
                ...
                "field_health_pct": field_health_pct,
                "field_biomass_pct": field_biomass_pct,
                "mean_grazing_pressure": mean_pressure,
                "degraded_area_pct": degraded_area_pct,
                "mean_ndvi_pct": mean_ndvi,
