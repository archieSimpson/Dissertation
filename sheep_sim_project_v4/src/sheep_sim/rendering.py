...
class LiveRenderer:
    ...
    def _draw_side_panel(self, counts: Counter, mean_speed: float, spread: float, pol: float, scenario: str, step: int) -> None:
        ...
        y -= line
        notes = [
            "Green indicates area-restricted grazing inside a productive patch.",
            "Teal indicates routine local walking between nearby good patches.",
            "Blue indicates stronger relocation/search, more common in scarce fields.",
